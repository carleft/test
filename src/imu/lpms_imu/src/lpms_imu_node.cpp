...
#define SELECT_STREAM_FREQ_200HZ    200   //200,300
...
class LpImuProxy
{
 public:
    ...
    void run(void)
    {
        ...
        updateTimer = ros::Timer(nh.createTimer(ros::Duration(1/rate),
                                                &LpImuProxy::update,
                                                this));
    }
 ...
 private:
    ...
    sensor_msgs::Imu imu_msg, tb_imu;

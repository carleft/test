...
public:
  ...
  virtual void onInit() {
    ...
    floor_pub = nh.advertise<prg_graph_slam::FloorCoeffs>("/floor_detection/floor_coeffs", 32);
...
private:
  ...
  void cloud_callback(const sensor_msgs::PointCloud2ConstPtr& cloud_msg) {
    ...
    prg_graph_slam::FloorCoeffs coeffs;
...
PLUGINLIB_EXPORT_CLASS(prg_graph_slam::FloorDetectionNodelet, nodelet::Nodelet)

...
{  
    ...
    nh.param<std::string>("path", path, "/home/tb/catkin_slam/src/hdl_localization/data/map.pcd");
	//nh.param<std::string>("path", path, "/home/tb/Ros/catkin_publish/src/publish_pointcloud/data/test.pcd");
